...
contract SimpleERC20Test is Test {
    ...
    function test_name() public view {
        assertEq(simpleERC20.name(), defaultName);
    }
    function test_symbol() public view {
        assertEq(simpleERC20.symbol(), defaultSymbol);
    }
    function test_totalSupply() public {
        vm.store(address(simpleERC20), bytes32(uint256(3)), bytes32(uint256(value)));
        assertEq(simpleERC20.totalSupply(), value);
    }
    function test_balanceOf() public {
        deal(address(simpleERC20), account1, value);
        assertEq(simpleERC20.balanceOf(account1), value);
    }
    function test_balanceOf222() public {
        deal(address(simpleERC20), account1, value);
        assertEq(simpleERC20.balanceOf(account1), value);
    }
